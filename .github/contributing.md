# Contributing to file-is-binary

First and foremost, thank you! We appreciate that you want to contribute to file-is-binary, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for file-is-binary**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for file-is-binary:

- star the [project](https://github.com/jonschlinkert/file-is-binary)
- tweet your support for file-is-binary
...
- **version**: please note the version of file-is-binary are you using
...
[so]: http://stackoverflow.com/questions/tagged/file-is-binary